...
public class CallBackAllInOne {

    private static final Logger log = LoggerFactory.getLogger(CallBackAllInOne.class);
    ...
    public static void allInOne(){
        Flux.<Integer>create(fluxSink -> {
                ...
                .doOnEach(signal -> log.info("Signal: {}: value: {}", signal.getType(), signal.get()))
                ...
                //.take(4)
                .subscribe(CommonUtils.subscriber("subscriber"));
    }
}
